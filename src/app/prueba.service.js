...
var PruebaService = (function () {
    ...
    PruebaService.prototype.getPrueba = function () {
        ...
        for (var i = 0; i < 1000; i++) {
            this.setrow().then(function (objPush) { arrInteractue.push(objPush); });
        }
        return Promise.resolve(arrInteractue);
    };
    PruebaService.prototype.setrow = function () {
        ...
        for (var j = 1; j < 11; j++) {
            ...
            name = "Prueba" + j;
            this.getText(j).then(function (data) {
                objPush[data] = {};
                objPush[data].name = name;
                objPush[data].color = color;
                console.log(objPush);
            });
        }
        return Promise.resolve(objPush);
    };
